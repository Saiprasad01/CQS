        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'patients')? 'active' : '' ?> d-flex align-items-start" aria-current="page" href="./?page=manage_patient"><span class="material-symbols-outlined">add</span> Add Record</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'patients')? 'active' : '' ?>" aria-current="page" href="./?page=patients">Patient List</a>
                    </li>
                    ...
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="./queueing.php" target="_blank">Monitor</a>
                    </li>
