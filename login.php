...
<head>
    ...
    <title>LOGIN | Clinic Queuing System</title>
...
<body class="bg-dark bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">Clinic Queuing System</h3>
            ...
            <div class="card-body">
                ...
                <form action="" id="login-form">
                    ...
                    <div class="mb-3 d-flex w-100 justify-content-between  align-items-end">
                        ...
                        <a href="./patient_side.php" target="_blank">Patient Form Page</a>
